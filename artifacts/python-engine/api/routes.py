...
@router.get("/healthz")
async def health():
    return {"status": "ok", "engine": "Latent Diffusion-HMM v3.0", "timestamp": datetime.utcnow().isoformat()}
...
async def analyze(req: AnalyzeRequest):
    ...
    Returns regime classification, feature tensor, trade signals, and surveillance status.
    """
    try:
